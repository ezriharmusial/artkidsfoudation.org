...
<div class="navbar-item ">
	<div class="buttons">
		...
		<button class="navbar-item button" class:is-success={$locale == 'nl'} class:is-text={$locale !== 'nl'} on:click={() => setRoutes('nl')} >
			<div class="icon-text">
