...
<div class="navbar-item ">
	<div class="buttons">
		<div class="my-3 mr-2 has-text-black icon">
		...
		<div class="navbar-item button is-text" class:is-active={$locale == 'en'} on:click={() => setRoutes('en')}>
				<span>
					English
				</span>
		</div>

		<div class="navbar-item button is-text" class:is-active={$locale == 'nl'} on:click={() => setRoutes('nl')} >
			<span>
				Nederlands
			</span>
		</div>
